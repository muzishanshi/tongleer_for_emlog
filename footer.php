...
$(function() {
	...
	$(document).on('submit', 'form[id!=loginForm]', function (event) {
...
var musicList = [
    {
		...
		lyric  : "<?php echo TEMPLATE_URL; ?>assets/smusic/data/tongkeke-huaxiawujian.lrc"
    },
    {
        title : '萌二代',
        singer : '童可可',
		...
		lyric  : "<?php echo TEMPLATE_URL; ?>assets/smusic/data/tongkeke-mengerdai.lrc"
    },
    {
        title : '吃货进行曲',
        singer : '童可可',
		...
		lyric  : "<?php echo TEMPLATE_URL; ?>assets/smusic/data/tongkeke-chihuojinxingqu.lrc"
    },
    {
        title : '小秘密',
        singer : '童可可',
		...
		lyric  : "<?php echo TEMPLATE_URL; ?>assets/smusic/data/tongkeke-xiaomimi.lrc"
    },
    {
        title : '听你爱听的歌',
        singer : '童可可',
		...
		lyric  : "<?php echo TEMPLATE_URL; ?>assets/smusic/data/tongkeke-tingniaitingdege.lrc"
    },
    {
        title : '别让我放不下',
        singer : '童可可',
		...
		lyric  : "<?php echo TEMPLATE_URL; ?>assets/smusic/data/tongkeke-bierangwofangbuxia.lrc"
    },
    {
        title : '非主恋',
        singer : '童可可',
		...
		lyric  : "<?php echo TEMPLATE_URL; ?>assets/smusic/data/tongkeke-feizhulian.lrc"
    }
];
</script>
